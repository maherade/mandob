                  ...
                  child: Column(
                    children: [
                          ...
                          Checkbox(
                              ...
                              onChanged: (bool? value) {
                                MandoobCubit.get(context)
                                    .changeCheckBox(value: value!);
                              }),
                          Text.rich(
                            TextSpan(
                                text:
                                    '${AppLocalizations.of(context)!.translate('privacyMessage').toString()} ',
                                style: GoogleFonts.almarai(
                                    fontSize:
                      ...
                      MaterialButton(
                        ...
                        color: ColorManager.primaryColor,
                        onPressed: () {
                          if (MandoobCubit.get(context).isCheckBoxTrue ==
                              true) {
