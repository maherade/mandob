...
class OpenIdImage extends StatelessWidget {
  const OpenIdImage({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return BlocConsumer<MandoobCubit, MandoobStates>(
      listener: (context, state) {
        if (state is UploadUserIdImageSuccessState) {
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    state is UploadUserIdImageLoadingState
                        ? const Align(
                        ...
                        : Align(
                            ...
                            child: FloatingActionButton(
                              ...
                              onPressed: () {
                                cubit.uploadUserIdImage().then((value) {
                                  Navigator.pop(context);
                                });
                              },
                              child: const Icon(
